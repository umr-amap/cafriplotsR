...
utils::globalVariables(c(
  ...
  "backbone_accepted_id", "backbone_authors", "backbone_family",
  "backbone_genus", "backbone_name_id", "backbone_resolved", "backbone_species",
  "backbone_status", "backbone_status_raw", "backbone_taxon_name",
  "external_id", "idtax_resolved", "match_similarity",
  ".match_id", "author_score", "authors_internal",

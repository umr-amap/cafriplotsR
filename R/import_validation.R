...
.check_duplicate_plots <- function(data, con) {
  ...
  tryCatch({
    ...
    method_name_to_id <- stats::setNames(method_lookup$id_method, method_lookup$method)
    country_name_to_id <- stats::setNames(country_lookup$id_country, country_lookup$country)

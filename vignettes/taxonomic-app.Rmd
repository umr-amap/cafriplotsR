...
- Removes duplicate names (preserving order)
- Creates a single column named `taxon_name` for matching

This method is ideal for:
- Quick checks of a few species names
- Pasting lists from emails or documents
- Testing the app without preparing a file

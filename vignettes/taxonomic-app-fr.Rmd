...
- **match_method** : Comment il a été apparié — `exact`, `genus_constrained`, `fuzzy`, `manual`, `unresolved` ou `no_match`. Voir [Valeurs de `match_method`](#valeurs-de-match_method) pour la signification de chacune, et pourquoi il n'existe ni `exact_species` ni `exact_genus`

...
Alternativement, utilisez le **mode hors ligne** (cliquez sur "Utiliser le mode hors ligne (référence en cache)" sur l'écran de connexion) pour travailler sans connexion active à la base de données.

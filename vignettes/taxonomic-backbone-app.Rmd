...
- **Visualize hierarchy** using the hybrid system (flat columns + id_parent tree structure)
- **Add new taxa** with automatic parent linking
...
- **Check consistency** between flat taxonomic columns and hierarchical structure
- **View and add traits** at the taxon level
...
1. **Database credentials** with appropriate permissions
2. **Understanding of taxonomic hierarchy** and nomenclatural rules
3. **Familiarity with the hybrid storage system** (explained below)
...
- Uses direct SQL for atomic operations

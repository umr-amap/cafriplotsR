...
- **Visualiser la hiérarchie** en utilisant le système hybride (colonnes plates + structure arborescente id_parent)
- **Ajouter de nouveaux taxons** avec liaison automatique aux parents
- **Modifier des taxons existants** avec mises à jour en cascade pour maintenir la cohérence
- **Gérer la synonymie** incluant la définition, l'inversion et l'annulation de relations synonymiques
- **Vérifier la cohérence** entre les colonnes taxonomiques plates et la structure hiérarchique
- **Voir et ajouter des traits** au niveau du taxon
...
1. **Identifiants de base de données** avec les permissions appropriées
2. **Compréhension de la hiérarchie taxonomique** et des règles nomenclaturales
3. **Familiarité avec le système de stockage hybride** (expliqué ci-dessous)
...
#### Recherche par Nom (Tous Niveaux)
